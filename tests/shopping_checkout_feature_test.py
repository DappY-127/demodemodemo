...
class TestShoppingCheckoutFeature(BaseTest):
    ...
    @allure.title("Place Order: Register before Checkout (via API)")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.story("Checkout Process")
    ...
    def test_order_placement_register_before_checkout_API(self):
        ...
        self.delete_account_via_api() 

    @allure.title("Place Order: Login before Checkout (via API)")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.story("Checkout Process")
    ...
    @allure.title("Search Products and Verify Cart After Login (via API)")
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.story("Checkout Process")
    ...
    def test_products_presence_at_cart_after_login_API(self):
        ...
        self.cart_page.click_home_button()
        self.self.delete_account_via_api()        